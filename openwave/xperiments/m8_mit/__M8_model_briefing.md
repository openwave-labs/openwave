...
| M8.12 | ✅ ALL FROZEN CLAIMS REPRODUCE (2026-09-21): the reduced Morse census of the level-6 quartic `r̂₆`, ten critical orbits with their exact values, transverse dimensions, signatures and characteristic polynomials, the `v₁` kernel and both ends, blind, two agents and an adversarial audit that found no mathematical defect. Sector-independent by D7. **No stability claim**: this is the Morse index of the leading reduced quartic transverse to the phase-and-rotation orbit, not the stability of a branch germ. No MODELS.md cell moves and M8.7's gate is unchanged ([`research/findings/m8_12_method_note.md`](research/findings/m8_12_method_note.md)) |
