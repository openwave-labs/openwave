...
**Location**: `quantum_wave.py` (not quantum_medium.py - keep it modular)
...
- Connect vertices to other granules via spring forces: spring links are already created at quantum_medium.py Spring class
