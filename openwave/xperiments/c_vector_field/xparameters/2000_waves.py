...
UNIVERSE_EDGE = 5.8e-14  # m, universe edge length in meters
TARGET_VOXELS = 50_000_000  # Target voxel count (impacts performance)
...
XPARAMETERS = {
    ...
    "color_defaults": {
        ...
        "COLOR_PALETTE": 2,  # redblue (1), yellowgreen (2), ironbow (3), viridis (4), blueprint (5)
    },
    "analytics": {
