...
import openwave.xperiments.m4_analytical_envelope.spacetime_medium as medium
import openwave.xperiments.m4_analytical_envelope.spacetime_ewave as ewave
import openwave.xperiments.m4_analytical_envelope.particle as particle
import openwave.xperiments.m4_analytical_envelope.force_motion as force_motion
import openwave.xperiments.m4_analytical_envelope.instrumentation as instrument
...
class XperimentManager:
    ...
    def load_xperiment(self, xperiment_name):
        ...
        try:
            module_path = (
                f"openwave.xperiments.m4_analytical_envelope.xparameters.{xperiment_name}"
            )
...
def display_level_specs(state, level_bar_vertices):
    ...
    with render.gui.sub_window("ANALYTICAL-ENVELOPE METHOD", 0.84, 0.01, 0.16, 0.16) as sub:
