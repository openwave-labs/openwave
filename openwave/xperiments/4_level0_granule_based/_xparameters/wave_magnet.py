...
XPARAMETERS = {
    ...
    "color_defaults": {
        ...
        "COLOR_PALETTE": 2,  # Color palette list: default (99), granule-type (0), redshift (1), ironbow (2), blueprint (3), viridis (4)
    },
    "analytics": {
        "ANALYTICS": False,  # Toggle analytics (speed & wavelength measurements)
