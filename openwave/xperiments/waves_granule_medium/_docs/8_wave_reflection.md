...
- using the files xwaves.py and ewave_granule.py as initial references, that simulates wave superposition
...
From xwaves.py and ewave_granule.py, the waves use:
