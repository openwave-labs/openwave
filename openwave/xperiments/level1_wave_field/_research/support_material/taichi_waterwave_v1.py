...
light_color = 1
gravity = 3.0  # larger gravity makes wave propagates faster
damping = 0.0  # larger damping makes wave vanishes faster when propagating
dx = 0.02
dt = 0.01
shape = 512, 512
    ...
    while gui.running:
        for e in gui.get_events(ti.GUI.PRESS):
            if e.key in [ti.GUI.ESCAPE, ti.GUI.EXIT]:
                ...
                x, y = e.pos
                create_wave(10, x * shape[0], y * shape[1])
        update()
        visualize_wave()
