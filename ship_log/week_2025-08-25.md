...
- Those classes live inside the module I'm calling `aether_space.py`, that also defines a specific terminology for the simulator itself:

  - `aether_space.py` for the Aether
