...
- **This is the Aether in 2D!** (static for now, with energy wave coming soon).
- Those classes live inside the module I'm calling `aether_medium.py`, that also defines a specific terminology for the simulator itself:

  - `aether_medium.py` for the Aether
...
### 3. Aether Granularity Scaling Complexity
...
- Added Aether Medium lattice implementation
- Initialized Taichi physics engine in `aether_medium.py`
