...
- **Crossing Waves Experiment**: Added new `xwaves` (crossing waves) experiment with dedicated `qwave_granule` kernel (Oct 16)
...
- Updated simulation parameters for quantum wave experiments (Oct 17-18)
