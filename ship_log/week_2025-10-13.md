...
- **Borescope**: video inspection camera with onboard lighting. The camera and light source penetrates the Medium and matter, it gets in between the particles. In the future we can play making a thermal camera, a magnetic camera, signal detector, spectrometer, etc
