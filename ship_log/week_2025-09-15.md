...
### Aether Medium Lattice Refactoring

- **Scaling Logic Improvements**: Refactored scaling logic in Aether Medium lattice and granule modules for better performance
...
- Implemented block-slice and plane-slice visualization methods for better analysis of Aether Medium internal regions for volumetric data inspection
...
Tested converting aether_medium (aka: aether) from a cubic to spherical universe
...
- `aba7f14` - Refactor scaling logic in Aether Medium lattice and granule
...
- aether_medium.py (aether) is done!
